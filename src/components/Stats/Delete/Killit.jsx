...
/*         <div>
      ...
      <h2 className="hamster-kill-world-ranking">WORLD RANKING</h2>
      <h2 className="hamster-kill-world-ranking-number">NR. 25</h2>
      </div>
      <img className="hamster-kill-pic" src="../pics/hamster-1.svg" alt=""/>
      </div>
      <div className="kill-details" >
      <h5 className="kill-percentage-text">WINNING PERCENTAGE</h5>
        {/* BAR */}
        ...
        <h4 className="kill-favourite-food">FAVORITE FOOD: MJÖLK</h4>
